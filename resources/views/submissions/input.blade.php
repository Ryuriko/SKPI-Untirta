    ...
    <div class="row justify-content-center">
        ...
        <div class="col-9 p-4 shadow-lg">
            <form method="post" action="/submissions">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="certificate-numbers" name="certificate-numbers">
                  </div>
                <div class="mb-3">
        ...
        <div class="row mt-5">
            <div class="col ms-5 text-center">
                <a href="/submissions" class="btn btn-primary"><i class="bi bi-arrow-left-square-fill"></i> Back</a>
            </div>
        </div>
@endsection